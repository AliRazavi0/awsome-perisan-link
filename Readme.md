...
- [لینک‌های ایرانی توسعه و طراحی](#لینکهای-ایرانی-توسعه-و-طراحی)
  - [پایتون Python](#پایتون-python)
  - [جاواسکریپت Javascript](#جاواسکریپت-javascript)
  - [Angular](#angular)
  - [Angular 1.x](#angular-1x)
  - [React](#react)
  - [Vue.js](#vuejs)
  - [پی اچ پی PHP](#پی-اچ-پی-php)
  - [روبی Ruby](#روبی-ruby)
  - [جاوا Java](#جاوا-java)
  - [گو GO](#گو-go)
  - [اندروید Android](#اندروید-android)
  - [سی پلاس پلاس C++](#سی-پلاس-پلاس-c)
  - [سی شارپ C♯](#سی-شارپ-c)
  - [لاتک latex](#لاتک-latex)
  - [آبجکتیو-سی Objective-C](#آبجکتیو-سی-objective-c)
  - [اپل‌اسکریپت AppleScript](#اپلاسکریپت-applescript)
  - [تایپ اسکریپت TypeScript](#تایپ-اسکریپت-typescript)
  - [ارندل arendelle](#ارندل-arendelle)
  - [گنو/لینوکس GNU/Linux](#گنولینوکس-gnulinux)
  - [فونت](#فونت)
  - [قالب](#قالب)
  - [گروه‌ها](#گروهها)
  - [آموزشی](#آموزشی)
...
درصورتی‌که برای درج لینک در این صفحه با مشکلی مواجه هستید یا پیشنهاد و انتقادی دارید در قسمت [ایشوها](https://github.com/AliRazavi0/awsome-perisan-link/issues) حتما در میان بگذارید. یا اینکه با آدرس .razavi.ali.1998 بر روی جی‌میل نامه‌نگاری فرمایید.
